...
namespace AlessandroGozzi.BookECommerce.DomainTests.Entities.CartFolder
{
    public class CartTests
    {
        ...
        public void AddItem_WhenItemDoesNotExist_ShouldAddNewItemToCart()
        {
            ...
            var result = cart.AddItem(bookId, Guid.NewGuid(), "Clean Code", ValidPrice, "cover.jpg");
        ...
        public void AddItem_WhenItemAlreadyExists_ShouldIncrementQuantity()
        {
            ...
            cart.AddItem(bookId, sellerId, "Clean Code", ValidPrice, "cover.jpg");
            var result = cart.AddItem(bookId, sellerId, "Clean Code", ValidPrice, "cover.jpg");
        ...
        public void RemoveItem_WhenItemExists_ShouldRemoveFromCart()
        {
            var cart = Cart.Create(Guid.NewGuid()).Value;
            var bookId = Guid.NewGuid();
            cart.AddItem(bookId, Guid.NewGuid(), "Clean Code", ValidPrice, "cover.jpg");
        ...
        {
            var cart = Cart.Create(Guid.NewGuid()).Value;
            cart.AddItem(Guid.NewGuid(), Guid.NewGuid(), "Book 1", ValidPrice, "cover1.jpg");
            cart.AddItem(Guid.NewGuid(), Guid.NewGuid(), "Book 2", ValidPrice, "cover2.jpg");
