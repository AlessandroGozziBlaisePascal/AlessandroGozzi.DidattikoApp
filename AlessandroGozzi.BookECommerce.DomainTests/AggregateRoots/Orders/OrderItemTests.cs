...
namespace AlessandroGozzi.BookECommerce.DomainTests.AggregateRoots.Orders
{
    public class OrderItemTests
    {
        ...
        private readonly ImageUrl ValidUrl = ImageUrl.Create("cover.jpg").Value;
        ...
        {
            var result = OrderItem.Create(_validBookId, _validSellerId, ValidBookTitle, _validPrice, ValidUrl, ValidQuantity);
        ...
        {
            var result = OrderItem.Create(Guid.Empty, _validSellerId, ValidBookTitle, _validPrice, ValidUrl, ValidQuantity);
        ...
        {
            var result = OrderItem.Create(_validBookId, Guid.Empty, ValidBookTitle, _validPrice, ValidUrl, ValidQuantity);
        ...
        {
            var result = OrderItem.Create(_validBookId, _validSellerId, invalidTitle!, _validPrice, ValidUrl,ValidQuantity);
        ...
        {
            var result = OrderItem.Create(_validBookId, _validSellerId, ValidBookTitle, null!, ValidUrl,ValidQuantity);
        ...
        {
            var result = OrderItem.Create(_validBookId, _validSellerId, ValidBookTitle, _validPrice, ValidUrl, invalidQuantity);
