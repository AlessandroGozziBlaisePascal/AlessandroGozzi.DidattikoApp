...
using AlessandroGozzi_BookECommerce.Domain.BookFolder.Event;
using AlessandroGozzi_BookECommerce.Domain.BookFolder.Value_Object;
using AlessandroGozzi_BookECommerce.Domain.CustomerFolder.Value_Object;

namespace AlessandroGozzi_BookECommerce.Domain.BookFolder
{
    public class Book: Entity
    {
        ...
        public int RationsNumber { get; private set; }
        ...
        public Result<Book> Create(string title, Guid sellerId, Subject sbj, ISBN code, int schoolYear, int publYear, Money price, BookStatus bookStatus)
        {
            if (title == null)
        ...
        public Result AddReview(BookReview r)
        {
            ...
            AverageRating = (double)TotalRating / RationsNumber;
        ...
        public Result RemoveReview(Guid customerId)
        {
            ...
            AverageRating = RationsNumber > 0 ? (double)TotalRating / RationsNumber : 0.0;
