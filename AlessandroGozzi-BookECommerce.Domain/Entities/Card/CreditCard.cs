...
using AlessandroGozzi_BookECommerce.Domain.Entities.Card.Value_Object;

namespace AlessandroGozzi_BookECommerce.Domain.Entities.Card
{
    public sealed class CreditCard: Entity
    {
        ...
        public static Result<CreditCard> Create(string rawName, string rawSurname, string rowExpiryDate, string last4digits, string token)
        {
            ...
            var expiryDateResult = ExpiryDate.Create(rowExpiryDate);
