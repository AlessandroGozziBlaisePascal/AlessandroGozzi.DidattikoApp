...
using AlessandroGozzi_BookECommerce.Domain.Entities.Card;
using AlessandroGozzi_BookECommerce.Domain.Entities.Customer.Event;
using AlessandroGozzi_BookECommerce.Domain.Entities.Customer.Value_Object;

namespace AlessandroGozzi_BookECommerce.Domain.Entities.Customer
{
